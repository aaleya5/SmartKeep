...
def upgrade() -> None:
    ...
    # Seed default row
    op.execute("INSERT INTO preferences (id, default_search_mode, default_library_view, default_sort_order, page_size, auto_enrich, llm_provider, ollama_base_url, max_content_length, theme, accent_color, reader_font_size, compact_density) VALUES (gen_random_uuid(), 'hybrid', 'grid', 'newest', 20, true, 'groq', 'http://localhost:11434', 10000, 'system', '#00C9A7', 'medium', false)")
