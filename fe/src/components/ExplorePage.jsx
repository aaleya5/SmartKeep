  ...
  return (
    <div className="explore-page">
      <div className="explore-header">
        <h1>Explore</h1>
        <p className="page-description">AI-powered discovery — surface patterns and connections in your knowledge base</p>
      </div>
      ...
      <div className="explore-grid">
        ...
        {/* Topic Clusters */}
        <div className="explore-card clusters-card">
          <TopicClusters 
            clusters={clusters} 
      ...
      <style>{`
        ...
        .gem-dust {
          position: absolute;
          inset: 0;
          background: url("data:image/svg+xml,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='10' cy='10' r='1' fill='%23a8a29e' opacity='0.3'/%3E%3Ccircle cx='30' cy='50' r='1' fill='%23a8a29e' opacity='0.2'/%3E%3Ccircle cx='80' cy='20' r='1' fill='%23a8a29e' opacity='0.3'/%3E%3C/svg%3E");
          opacity: 0.5;
        }
